...
//先不着急配置DispatcherServlet，而是先配置ServletWebServerFactoryAutoConfiguration
//ServletWebServerFactoryAutoConfiguration是web服务器的自动配置
...
public class DispatcherServletAutoConfiguration {
	...
	//DispatcherServlet只有放入到Tomcat中才有用
	protected static class DispatcherServletRegistrationConfiguration {

		//通过DispatcherServletRegistrationBean完成注册
		//DispatcherServletRegistrationBean又是一个ServletContextInitializer，所以其会被传被tomcat初始化
		@Bean(name = DEFAULT_DISPATCHER_SERVLET_REGISTRATION_BEAN_NAME)
		@ConditionalOnBean(value = DispatcherServlet.class, name = DEFAULT_DISPATCHER_SERVLET_BEAN_NAME)
		//在前面DispatcherServlet注册好之后，再注册DispatcherServletRegistrationBean
		//DispatcherServletRegistrationBean会由tomcat启动完成后回调onStartup方法(父类存在)，完成注册
